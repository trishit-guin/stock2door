            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                  ...
                  className="bg-accent text-white py-3 px-8 rounded-lg font-medium hover:bg-accent/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {isOptimizing ? (
              ...
              <div className="card">
                ...
                <div className="w-full h-96 bg-gray-100 rounded-lg overflow-hidden">
                  <iframe
                    ...
                    frameBorder="0"
                    src={(() => {
                      const baseUrl = `https://www.google.com/maps/embed/v1/directions?key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}&origin=${encodeURIComponent(optimizedRoute.source)}&destination=${encodeURIComponent(optimizedRoute.destination)}&region=IN&mode=driving`;
                      const avoidParam = selectedRouteIndex === 1 ? '&avoid=highways' : selectedRouteIndex === 2 ? '&avoid=tolls' : '';
                      return baseUrl + avoidParam;
                    })()}
                    allowFullScreen
                    title="Route Map"
                    className="border-0"
